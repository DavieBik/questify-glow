...
-- Add 5 multiple-choice quiz questions with answer options
DO $$
DECLARE
  quiz_module_id UUID;
  q1_id UUID;
...
BEGIN
  ...
  INSERT INTO public.quiz_questions (
    module_id, question_text, question_type, points, order_index
  ) VALUES (
    quiz_module_id,
    'What is the single most effective measure to prevent the spread of infections in healthcare settings?',
    'multiple_choice', 20, 1
  ...
  INSERT INTO public.quiz_questions (
    ...
    quiz_module_id,
    'How many critical moments for hand hygiene are defined by WHO?',
    'multiple_choice', 20, 2
  ...
  INSERT INTO public.quiz_questions (
    ...
    quiz_module_id,
    'Which is the correct duration for handwashing with soap and water?',
    'multiple_choice', 20, 3
...
-- Update course with Demo-Ready tag and certificate settings
