-- Add course visibility and content management features (fixed)

-- Update courses table to support visibility controls
...
CREATE TABLE IF NOT EXISTS public.organization_subscriptions (
  ...
  price_aud_cents integer, -- Australian pricing in cents
...
-- Create demo courses (without created_by for now)
INSERT INTO public.courses (
  id, title, description, short_description, category, difficulty, 
  estimated_duration_minutes, is_mandatory, is_active, 
  visibility_type, owner_type, organization_id
) VALUES
-- Acme Private Courses
(gen_random_uuid(), 'Introduction to Person-Centred Disability Support', 
...
(gen_random_uuid(), 'Acme Workplace Health & Safety for Disability Support',
...
(gen_random_uuid(), 'DiamondCare Client Engagement Best Practices',
...
(gen_random_uuid(), 'DiamondCare Emergency Procedures',
...
(gen_random_uuid(), 'Mandatory Reporting Requirements in Disability Services',
...
(gen_random_uuid(), 'Effective Communication in Care Settings',
...
(gen_random_uuid(), 'Infection Prevention & Control',
...
(gen_random_uuid(), 'Working with Diverse Clients',
...
-- Update subscription data for demo orgs
