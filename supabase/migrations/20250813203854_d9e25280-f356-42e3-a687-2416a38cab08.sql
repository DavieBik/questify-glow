-- Fix Security Definer Views - Corrected column names
...
-- Using created_at instead of enrolled_at
...
SELECT 
  DATE_TRUNC('week', uce.created_at) AS week_start,
...
WHERE uce.created_at >= CURRENT_DATE - INTERVAL '90 days'
GROUP BY DATE_TRUNC('week', uce.created_at)
ORDER BY week_start;
